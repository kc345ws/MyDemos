package com.supermarket.chc.supermarket.dao.impl;

import com.supermarket.chc.supermarket.dao.UsersDao;
import com.supermarket.chc.supermarket.entity.Users;
import com.supermarket.chc.supermarket.entity.UsersView;
import com.supermarket.chc.supermarket.util.BaseDao;
...
public class UsersDaoImpl extends BaseDao implements UsersDao {
	...
	public Users findByAcc(String acc) {
		Users user = new Users();
		String sql="select userid,uname,usex,to_char(ubirth,'YYYY-MM-DD'),utel,uadd,utype from users where uname=?";
		// 1)获得连接
		con = this.getPoolConnection();
		// 2)ps对象
		try {
