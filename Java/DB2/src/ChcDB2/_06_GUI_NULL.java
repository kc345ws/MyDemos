...
public class _06_GUI_NULL {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        JFrame frame = new JFrame("06_GUI-NULL--5170933陈鸿超");
        ...
        Object[][] elements = MyDB2_06.Instance.getElements();
        //向表格添加数据
        ...
        addLineBTN.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                tableModel.addRow(new Object[]{});
                MyDB2_06.Instance.newEmployee.add(new Employee());//添加空的雇员信息
                SumCount++;
            }
        });
        ...
        commitBTN.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                //存入修改后的旧的雇员信息
                MyDB2_06.Instance.oldEmployee.clear();
                for(int i = 0 ; i < ElementCount;i++){
                    ...
                    MyDB2_06.Instance.oldEmployee.add(employee);
                }
                ...
                for(int i = ElementCount ; i < SumCount ;i++){
                    ...
                    Employee employee = new Employee(no,fn,mid,ln);
                    MyDB2_06.Instance.newEmployee.set(count,employee);
                    count++;
                }
                ...
                //更新//插入
                try {
                    MyDB2_06.Instance.Update();
                    MyDB2_06.Instance.Insert();
...
class MyDB2_06{
    public static MyDB2_06 Instance;
    ...
    private MyDB2_06() throws SQLException {
        try {
            //导入DB2驱动
