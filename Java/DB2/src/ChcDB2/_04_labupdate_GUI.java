...
/* Class definition                                                   */
/**********************************************************************/
public class _04_labupdate_GUI
{
/**********************************************************************/
...
/**********************************************************************/
        ...
        deptno = JOptionPane.showInputDialog(null,"Please enter a department number: ");
        ...
        try
        {
            ...
            JOptionPane.showConfirmDialog(null,"Number of rows updated: " + updateCount);
        }  // end try
