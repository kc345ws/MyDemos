package com.supermarket.chc.supermarket.util;

import com.supermarket.jdbc.util.JDBCUtil02;
...
public class BaseDao {
	...
	public Connection getPoolConnection() {
		...
		try {
			...
			// 2.获得数据源
			//DataSource dataSource = (DataSource) context.lookup("jdbc:oracle:thin:@127.0.0.1:1521:orcl");
			//DataSource dataSource = (DataSource) context.lookup("java:comp/env/jdbc/orcl");
			// 3.获得连接对象
			return JDBCUtil02.getConn();
