...
<div class="row" style="width:1210px;margin:0 auto;">
    ...
    <div class="col-md-2">
        ...
        <p><a href="../ProductInfoServlet?id=1" style='color:green'>冬瓜</a></p>
    ...
    <div class="col-md-2">
        ...
        <p><a href="../ProductInfoServlet?id=2" style='color:green'>圆白菜</a></p>
        <p><font color="#FF0000">商城价：&yen;299.00</font></p>
    </div>
    ...
    <div class="col-md-2">
        ...
        <p><a href="../ProductInfoServlet?id=3" style='color:green'>甜玉米</a></p>
        <p><font color="#FF0000">商城价：&yen;299.00</font></p>
    </div>
    ...
    <div class="col-md-2">
        ...
        <p><a href="../ProductInfoServlet?id=4" style='color:green'>胡萝卜</a></p>
        <p><font color="#FF0000">商城价：&yen;299.00</font></p>
    </div>
    <div class="col-md-2">
        ...
        <p><a href="../ProductInfoServlet?id=5" style='color:green'>芹菜</a></p>
        <p><font color="#FF0000">商城价：&yen;299.00</font></p>
    </div>
    ...
    <div class="col-md-2">
        ...
        <p><a href="../ProductInfoServlet?id=6" style='color:green'>韭菜</a></p>
        <p><font color="#FF0000">商城价：&yen;299.00</font></p>
    </div>
...
<div style="width:1210px;margin:0 auto; padding: 0 9px;border: 1px solid #ddd;border-top: 2px solid #999;height: 246px;">
    ...
    <h4 style="width: 50%;float: left;font: 14px 微软雅黑;">浏览记录</h4>
    ...
    <div style="overflow: hidden;">
        ...
        <ul style="list-style: none;">
            ...
            <%
                    ...
                    for (String id : ids){
             %>
            <li style="width: 150px;height: 216px;float: left;margin: 0 8px 0 0;padding: 0 18px 15px;text-align: center;"><img src="products/1/cs1000<%=id%>.jpg" width="130px" height="130px" /></li>
            <%
                    }
                }
            %>
        ...
        <div><a href="../ClearHistory">清除浏览记录</a></div>
    </div>
</div>
